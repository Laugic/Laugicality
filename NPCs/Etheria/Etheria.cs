...
namespace Laugicality.NPCs.Etheria
{
    ...
    public class Etheria : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (Main.dayTime == true) { npc.position.Y -= 20; }
            ...
            if (npc.life < npc.lifeMax * .10 && phase == 4 && Main.expertMode && modPlayer.etherial)
            {
            ...
            if (npc.life < npc.lifeMax * .20 && phase == 5 && Main.expertMode && modPlayer.etherial)
            {
                phase += 1;
                attackDelMax -= 20;
            }
