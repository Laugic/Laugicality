...
namespace Laugicality.NPCs.Etheria
{
	public class EtherialPulsar : ModProjectile
	{
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 7, 0, mod.ProjectileType("EtherialPulse"), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, -7, 0, mod.ProjectileType("EtherialPulse"), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, -7, mod.ProjectileType("EtherialPulse"), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 7, mod.ProjectileType("EtherialPulse"), damage, 3f, Main.myPlayer);
