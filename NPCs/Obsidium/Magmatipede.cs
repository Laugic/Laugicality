...
namespace Laugicality.NPCs.Obsidium
{
    ...
    {
		public override string Texture { get { return "Laugicality/NPCs/Obsidium/MagmatipedeHead"; } }
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if (LaugicalityWorld.obsidiumTiles > 250 && spawnInfo.spawnTileY > WorldGen.rockLayer && LaugicalityWorld.downedRagnar)
                return SpawnCondition.Cavern.Chance * 0.55f;
            else return 0f;
        }
    ...
    {
		public override string Texture { get { return "Laugicality/NPCs/Obsidium/MagmatipedeBody"; } }
    ...
    {
		public override string Texture { get { return "Laugicality/NPCs/Obsidium/MagmatipedeTail"; } }
	...
	public abstract class Magmatipede : Worm
	{
        ...
        /*public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if (LaugicalityWorld.obsidiumTiles > 250 && spawnInfo.spawnTileY > WorldGen.rockLayer - 150  && LaugicalityWorld.downedRagnar)
                return SpawnCondition.Cavern.Chance * 0.55f;
            else return 0f;
        }*/
