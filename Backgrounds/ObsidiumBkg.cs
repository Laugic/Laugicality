...
{
	public class ObsidiumBkg : ModSurfaceBgStyle
    {
        public const string
        ...
        {
            return mod.GetBackgroundSlot("Backgrounds/ObsidiumFar");
        }
        ...
        {
            return mod.GetBackgroundSlot("Backgrounds/ObsidiumMid");
            /*
        ...
        {
            return mod.GetBackgroundSlot("Backgrounds/ObsidiumClose");
        }
    }
}