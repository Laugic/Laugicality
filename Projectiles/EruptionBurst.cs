	...
	public class EruptionBurst : ModProjectile
	{
		...
		public override void AI()
        {
            ...
            if (Main.rand.Next(2) == 0 && Main.myPlayer == projectile.owner)
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X + -5+Main.rand.Next(0,11), -Main.rand.Next(5,10),  mod.ProjectileType("EruptionBurstUp"), 30, 3, Main.myPlayer);
