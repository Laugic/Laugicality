		...
		public override void PostAI()
        {
            ...
            if (reload <= 0)
            {
                ...
                if (Main.myPlayer == projectile.owner)
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 4 - Main.rand.Next(8), 4 - Main.rand.Next(8), mod.ProjectileType("AnDioYoShot"), 32, 3f, Main.myPlayer);
            }
        }
	}
}
