...
{
	public class HallowsEveDestruction1 : ModProjectile
    {
        public int damage = 0;
        ...
        public override void AI()
        {
			...
			if (projectile.timeLeft == 120)
			{
				...
				while ((float)num103 < num102)
				{
					...
					int num104 = Dust.NewDust(projectile.Center, 0, 0, 6, 0f, 0f, 0, default(Color), 2f);
			...
			for (int num363 = 0; num363 < 2; num363++)
			{
				...
				int num366 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 6, 0f, 0f, 0, default(Color), 1.5f);
