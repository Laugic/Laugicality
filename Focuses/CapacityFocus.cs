...
namespace Laugicality.Focuses
{
    public sealed class CapacityFocus : Focus
    {
        public CapacityFocus() : base("CapacityFocus", "Capacity", Color.Blue, new FocusEffect[]
        {
            ...
            new FocusEffect(p => Main.hardMode, DownedWallOfFleshEffect, new TooltipLine(Laugicality.instance, "CapacityFocusDownedWallOfFleshEffect", "Taking more than 1 damage is reduced to 1 damage once every 2 minutes. Innate inferno potion") { overrideColor = new Color(0xAC, 0x39, 0x5A) }),
