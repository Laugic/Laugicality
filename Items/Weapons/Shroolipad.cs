...
public class Shroolipad : ModItem
        ...
        public override void SetDefaults()
    {
        ...
        item.shootSpeed = 10f;
        item.summon = true;
            item.buffType = mod.BuffType("Shroolicopter"); //The buff added to player after used the item
            item.buffTime = 3600;
        }
    ...
    public override bool Shoot(Player player, ref Microsoft.Xna.Framework.Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
    {
		...
		Projectile.NewProjectile(vector2.X, vector2.Y, num78, num79, mod.ProjectileType("Shroolicopter"), num73, num74, i, 0f, 0f);
