...
namespace Laugicality.Items.Weapons.Melee
{
    public class TrueDaysBreak : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shootSpeed = 16f;
            item.shoot = mod.ProjectileType("TrueGoldenSword");
            item.scale *= 1.25f;
        }
        ...
        {
            target.AddBuff(mod.BuffType("TrueDawn"), 12 * 60 + Main.rand.Next(8 * 60));
        }

        public override void AddRecipes()
        {
            ModRecipe recipe = new ModRecipe(mod);
            recipe.AddIngredient(mod.ItemType("DaysBreak"));
