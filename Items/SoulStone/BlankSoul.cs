...
{
    public class BlankSoul : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Blank Soul Stone");
            Tooltip.SetDefault("Creates a Soul Stone bound to your Soul. \nRight click to use. \nCleanses your Soul in the process, erasing the Soul Stone stats for all other characters.\nYou can regain your progress using medallions on other characters");
        }
