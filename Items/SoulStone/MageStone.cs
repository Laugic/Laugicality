...
{
    public class MageStone : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Enfuses your soul with the essence of a Mage \nMagic and Utility focus \nRight click to bind your Soul");
        }
        ...
        {
            //Player Vars
            player.GetModPlayer<LaugicalityPlayer>().Class = (int)LaugicalityVars.ClassType.Mage;
