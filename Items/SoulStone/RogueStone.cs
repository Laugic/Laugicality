...
{
    public class RogueStone : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Enfuses your soul with the essence of a Rogue \nRange and Mobility focus \nRight click to bind your Soul");
        }
        ...
        {
            //Player Vars
            player.GetModPlayer<LaugicalityPlayer>().Class = (int)LaugicalityVars.ClassType.Rogue;
