...
{
    public class SporalSoulCrystal : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Increases max minions and mana regeneration \n'You feel tingly outside' \nRight click to activate. Can only activate one part.");
        }
        ...
        {
            if (Items.Accessories.SoulStone.PTalt == 0)
            {
                player.QuickSpawnItem(ItemID.SporeSac);
                Items.Accessories.SoulStone.PTalt = 1;
                Items.Accessories.SoulStone.PTb += 1;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "NaturalSoulCrystal");
