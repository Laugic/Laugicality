...
{
    public class TankStone : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Enfuses your soul with the essence of a Tank \nMelee and Defense focus \nRight click to bind your Soul");
        }
        ...
        {
            //Player Vars
            player.GetModPlayer<LaugicalityPlayer>().Class = (int)LaugicalityVars.ClassType.Tank;
