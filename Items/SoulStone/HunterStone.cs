...
namespace Laugicality.Items.SoulStone
{
    public class HunterStone : ModItem
    {
        ...
        {
            Tooltip.SetDefault("Enfuses your soul with the essence of a Hunter \nRange and Utility focus \nRight click to bind your Soul");
        }
        ...
        {
            //Player Vars
            player.GetModPlayer<LaugicalityPlayer>().Class = (int)LaugicalityVars.ClassType.Hunter;
