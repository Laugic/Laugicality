...
{
    public class NecromancerStone : ModItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Enfuses your soul with the essence of a Necromancer \nSummon and Damage focus \nRight click to bind your Soul");
        }
        ...
        {
            //Player Vars
            player.GetModPlayer<LaugicalityPlayer>().Class = (int)ClassType.Necromancer;
